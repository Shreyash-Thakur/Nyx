...
def upgrade() -> None:
    # Enums
    op.execute("CREATE TYPE user_role AS ENUM ('admin', 'accountant', 'viewer')")
    op.execute(
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="invoice_status"), nullable=False, server_default="uploaded"),
        sa.Column("payment_status", sa.Enum(name="payment_status"), nullable=False, server_default="pending"),
    ...
    op.create_table(
        ...
        sa.Column("status", sa.Enum(name="reconciliation_status"), nullable=False, server_default="pending"),
        sa.Column("discrepancy_type", sa.Enum(name="discrepancy_type"), nullable=True),
